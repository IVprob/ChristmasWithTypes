...
namespace ChristmasWithTypes
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //DONE set Santa's name to Kris Kringle. Just added the string. This is in the Christmas.cs file for class Christmas.
            xmas.Santa = "Kris Kringle";

            //Done Insert 3 presents you would like for xmas. They must be strings
            xmas.Presents =  new string[3]{"xbox1", "Aquaponics Kit", "New Job"}; 
